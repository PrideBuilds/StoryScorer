...
export const metadata = {
  ...
  description: "Read StoryScorer's Terms of Service and understand your rights and responsibilities.",
};
    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-slate max-w-none space-y-8">
        <Card>
          ...
          <CardContent>
            <p>
              By accessing or using StoryScorer ("Service"), you agree to be bound by these
          ...
          <CardContent className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                ...
                threatening, abusive, or violates intellectual property rights
              </li>
              <li>
              ...
              <li>
                Use the Service for any commercial purpose other than analyzing your own user
                stories
              </li>
              <li>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p>
                ...
                Pricing and plan details are available on our pricing page and may change with
                notice.
              </p>
            </div>
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  All fees are non-refundable except as required by law or stated in our
                  refund policy
                </li>
              </ul>
            </div>
            <div>
              ...
              <p>
                ...
                must be made within 30 days of the initial purchase. Refunds are processed
            ...
            <div>
              ...
              <p>
                We reserve the right to modify subscription prices. Price changes will be
                communicated at least 30 days in advance. Your continued use after the
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              <h3 className="font-semibold mb-2">5.1 Our Intellectual Property</h3>
              <p>
                The Service, including all content, features, functionality, and software, is
                owned by StoryScorer and protected by copyright, trademark, and other laws.
            ...
            <div>
              ...
              <p>
                You retain ownership of the user stories and content you submit. By using the
            ...
            <div>
              ...
              <p>
                Any feedback, suggestions, or ideas you provide about the Service may be used
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              We strive to maintain high availability but do not guarantee uninterrupted or
              error-free service. We may:
            </p>
            <ul className="list-disc pl-6 space-y-1">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, STORYSCORER SHALL NOT BE LIABLE FOR:
            </p>
            <ul className="list-disc pl-6 space-y-1">
              <li>
            ...
            <p>
              Our total liability for any claims shall not exceed the amount you paid us in
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p>
              ...
              or that defects will be corrected. Analysis results are provided for informational
              purposes and should not be the sole basis for business decisions.
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p>
                ...
                delete your account and data, though we may retain certain information as
        ...
        <Card>
          ...
          <CardContent>
            <p>
              ...
              be notified via email or prominent notice on the Service. Your continued use
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p>
                ...
                between you and StoryScorer regarding the Service.
              </p>
            </div>
            <div>
