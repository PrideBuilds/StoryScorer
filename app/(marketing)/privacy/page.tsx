...
export const metadata = {
  ...
  description:
    "Learn how StoryScorer collects, uses, and protects your personal information.",
};
    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-slate max-w-none space-y-8">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  ...
                  full name, company name, and job title when you create an
                  account
                </li>
                <li>
                  <strong>User Stories:</strong> The user stories, acceptance
                  criteria, and related content you submit for analysis
                </li>
                <li>
                  <strong>Payment Information:</strong> Processed securely
                  through Stripe (we do not store credit card information)
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  ...
                  similar tracking technologies to enhance your experience (see
                  Section 5)
                </li>
              </ul>
            </div>
          ...
          <CardContent className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>
                ...
                improve our AI-powered story analysis services
              </li>
              <li>
              ...
              <li>
                ...
                with our service and improve our features
              </li>
              <li>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              We use trusted third-party services to operate our platform. These
            ...
            <div>
              ...
              <p>
                We use AI service providers (OpenAI and/or Anthropic) to analyze
                your user stories. Your story content is sent to these services
                for analysis but is not used to train their models. Review their
                privacy policies:
              </p>
          ...
          <CardContent className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                ...
                use our service (we use privacy-friendly analytics)
              </li>
              <li>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              ...
              will delete or anonymize your personal information, except where
              we are required to retain it for legal or legitimate business
              purposes.
            </p>
            <p>
              User stories and analysis history are retained according to your
              plan limits and can be deleted at any time through your account
              settings.
            </p>
          </CardContent>
        </Card>
